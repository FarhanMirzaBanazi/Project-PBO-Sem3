 ...
 * @author Fatma
 */
public class Godzilla extends javax.swing.JFrame {
    String kursi;

    /**
     * Creates new form Godzilla
     */
    public Godzilla() {
        initComponents();
        ...
        Image img10 = img9.getScaledInstance(godz.getWidth(), godz.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon godzilla=new ImageIcon(img10);
        godz.setIcon(godzilla);
        
        ImageIcon myimagee4 = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource("bg2.png")));
        Image img1b = myimagee4.getImage();
        //Image img2b = img1b.getScaledInstance(bgr.getWidth(), bgr.getHeight(), Image.SCALE_SMOOTH);
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(godz, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 160, 250));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(27, 558, -1, -1));
        ...
        getContentPane().add(T_kursi, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 340, 210, 30));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menuTiket/bg2.png"))); // NOI18N
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        menu.setDefaultCloseOperation(Godzilla.EXIT_ON_CLOSE);
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        h.setDefaultCloseOperation(Godzilla.EXIT_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Godzilla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel godz;
