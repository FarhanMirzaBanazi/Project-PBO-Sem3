 ...
 * @author Fatma
 */
public class fastFr extends javax.swing.JFrame {
    String kursi; 

    /**
     * Creates new form fastFr
     */
    public fastFr() {
        initComponents();
        ...
        Image img8 = img7.getScaledInstance(ffr.getWidth(), ffr.getHeight(), Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        getContentPane().add(ffr, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, 150, 260));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        menu.setDefaultCloseOperation(fastFr.EXIT_ON_CLOSE);
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        h.setDefaultCloseOperation(fastFr.EXIT_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fastFr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel ffr;
