 ...
 * @author Fatma
 */
public class tokRev extends javax.swing.JFrame {
    String kursi;

    /**
     * Creates new form tokRev
     */
    public tokRev() {
    initComponents();
    ...
    Image img4 = img3.getScaledInstance(tokrev.getWidth(), tokrev.getHeight(), Image.SCALE_SMOOTH);
    ImageIcon tokyorev=new ImageIcon(img4);
    tokrev.setIcon(tokyorev);
    ...
    private void initComponents() {
        ...
        C_day1 = new javax.swing.JComboBox<>();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        getContentPane().add(tokrev, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 200, 150, 240));
        ...
        C_day1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Pilih--", "Minggu ", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu" }));
        C_day1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                C_day1ActionPerformed(evt);
            }
        });
        getContentPane().add(C_day1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 90, 230, 30));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        menu.setDefaultCloseOperation(tokRev.EXIT_ON_CLOSE);
    ...
    private void C_day1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_C_day1ActionPerformed
        // TODO add your handling code here:
        int harga;
        if(C_day.getSelectedItem() == "Minggu"){
            harga = 50000;
        ...
        t_harga.setText(String.valueOf(harga));
    }//GEN-LAST:event_C_day1ActionPerformed
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        h.setDefaultCloseOperation(tokRev.EXIT_ON_CLOSE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tokRev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> C_day1;
    ...
    private javax.swing.JLabel tokrev;
